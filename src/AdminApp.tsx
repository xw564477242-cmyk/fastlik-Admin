    ...
    <div className="app-shell">
      ...
      <main className="admin-main">
        ...
        <div className="page-content">
          ...
          {active === 'operations' && <OperationsWorkspace session={session} tenantId={tenantId} onUnauthorized={onLogout} />}
...
function OperationsWorkspace({ session, tenantId, onUnauthorized }: { session: AdminSession; tenantId: string; onUnauthorized: () => void }) {
